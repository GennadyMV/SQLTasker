package wepaht.SQLTasker.constant;
...
public abstract class ConstantString {
    ...
    public static final String ATTRIBUTE_COURSES = "courses";
    ...
    public static final String ATTRIBUTE_NAV_USERS = "Users";
    public static final String ATTRIBUTE_NAV_TASKS = "Tasks";
    public static final String ATTRIBUTE_NAV_DATABASES = "Databases";
    public static final String ATTRIBUTE_NAV_SUBMISSIONS = "Submissions";
    public static final String ATTRIBUTE_NAV_FEEDBACK = "Feedback";
    ...
    public static final String LINK_COURSES = "/courses";
